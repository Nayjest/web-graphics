...
(function() {
  ...
  define(['components/graphics/lib/layers/dom/DomLayer', 'components/underscore/underscore'], function(DomLayer) {
    var CanvasViewport;
    return CanvasViewport = (function(_super) {
      ...
      CanvasViewport.prototype.clear = function() {
        this.context.clearRect(0, 0, this.getSize()[0], this.getSize()[1]);
        return this;
      };
