...
(function() {
  ...
  define(['components/graphics/lib/layers/AbstractActiveLayer', 'components/Vector2D/Vector2D', "components/jquery/jquery", "components/underscore/underscore"], function(AbstractLayer, Vector2D) {
    "use strict";
    ...
    return AbstractDomLayer = (function(_super) {
      ...
      */
      ...
      AbstractDomLayer.prototype._calcDomOffset = function() {
        var a, angleMod, d, domParentSize, innerTopRightPos, nonDomOffset, parentOffset, res, size, zoom;
        ...
        if (this.angle) {
          d = size.magnitude();
          a = (90 - this.angle % 90) * (Math.PI / 180);
          angleMod = {
